...
<div class="page">
 ...
 <a href = ""><b>BookList</b></a> &nbsp;

  <div class="dropdown-content">
    <a href="DisplyBookServlet">DisplayBooks</a>
    ...
    <a href = "BookReserve.jspff"><b>BookReserved</b></a> &nbsp;
...
<a href = "home.html"><b>GenerateReports</b></a>
  ...
  <div class="dropdown-content">
    ...
    <a href="BookListServlet">BookList</a>
     <a href="AddEvents.jsp">Add Event</a>
  </div>
</div>
    </center>
    </div>
